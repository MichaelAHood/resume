...
\textsc{Present} & \emph{Tweet Tokeniser}\\ 
\textsc{Fall 2014} & \footnotesize{The project aims at creating a tokeniser for tweets, segmenting tweet sentences into invidual tokens of words or entities. As an additional feature the tokeniser will normalise dates in the sentences as well.}\\
\multicolumn{2}{c}{} \\
